...
Class module_Lisrender extends ModuleBase implements IModuleBase {
 ...
 @access public
 @param string $file Le fichier css à importer
 */
 public function ImportCss($file)
    ...
    */
    public function SetTypeMouse($type="rond",$color=BLEU,$res_ext="not")
    {
        ...
        else
        {
            ...
            // Et il doit être alors le type plus la couleur (ex: rond 255|0|0)
    ...
    */
    ...
    /* 
      ...
      @param boolean $share True si le calque est partagé par toutes les instance de l'application sinon false s'il est unique à cette instance
    */
    public function AddCalque($nom,$largeur=0,$hauteur=0,$width=0,$height=0,$x=0,$y=0,$ressource=false,$share=false)
    {
        ...
        if (!$ressource)
        {
            // On lui associé une ressource crée à la volée
        ...
        {
            // Sinon on crée une ressource à la volée avec l'image précharger dedans
    ...
    */
    ...
    /*
      ...
      @access public
      @param boolean $destroy_screen Si true le conteneur est supprimé après chaque frame
    ...
    */
    public function AfficherTexte($res,$texte,$x,$y,$couleur)
    {
        ...
        // On signale que le calque à été modifié
